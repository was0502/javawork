...
public class T05_random {
	...
	public static void main(String[] args) {
		...
		System.out.println(random1); // 실수형 : 0~0.999999999
		System.out.println("---------------------");
		
		// o ~ 9.999999999
		random1 = Math.random()*10;
		System.out.println(random1); // 실수형 : 0 ~ 9.999999999
		
		int random2 = (int)random1; //정수로 강제 형변화: 0 ~ 9

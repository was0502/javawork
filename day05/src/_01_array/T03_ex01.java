...
public class T03_ex01 {
	...
	public static void main(String[] args) {
		// 시용자로부터 5사람의 국어, 수학, 컴퓨터 점수 입력
		/*
		번호 국어 수학 컴퓨터 총점 평균
		---------------------------
		 1  89  100 100 290 96.67
		...
		System.out.println("첫번째 학생 수학점수 입력");
		score [0][1] = scan. nextInt();
		System.out.println("첫번째 학생 컴퓨터점수 입력");
		score [0][2] = scan. nextInt();
		
		System.out.println("두번째 학생 국어점수 입력 : ");
		score [1][0] = scan. nextInt();
		System.out.println("두번째 학생 수학점수 입력 :");
		score [1][1] = scan. nextInt();
		System.out.println("두번째 학생 컴퓨터점수 입력 :");
		...
		System.out.println(2 + ".두번째 학생 국어, 수학, 컴퓨터 점수 입력 : ");
		score [1] [0] = scan. nextInt();
		score [1] [1] = scan. nextInt();
		score [1] [2] = scan. nextInt();
		*/
		...
		for(int i=0; i<score.length; i++) {
			...
			System.out.println(sum+ "\t"); // 1번째 학생의 총점이 들어있음
